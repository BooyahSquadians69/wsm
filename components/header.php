...
<header class="text-gray-600 body-font">
    <div class="container grid place-items-center p-4">
        <a class="flex title-font font-medium items-center text-gray-700 hover:text-gray-700 mb-4 md:mb-0" style="text-decoration: none" href="./">
        ...
        <nav class="flex flex-wrap text-base items-center justify-center ">
            <a class="mr-5 hover:text-gray-900" href="./" style="text-decoration:none;">
