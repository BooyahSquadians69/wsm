...
if (!isset($_SESSION['admin_logged_in']) || $_SESSION['admin_logged_in'] == false) {
   ...
   foreach ($type_list as $type) {
      ...
      if ($num !== 0) {
         ...
         while ($row = mysqli_fetch_assoc($res)) {
            ...
            $pdf->MultiCell(190, 13, $row['submission'], 0, 'C');
   ...
   echo '<div class="container"><div class="alert alert-success container" role="alert">
   PDF was generated successfully<br>
   <a href="./'.$path.'"> click here to read pdf </a>
   </div></div>';
